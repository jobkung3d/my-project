...
class Home extends Component{
    ...
    componentDidMount(){
        this.setState({ projects :[
            { projectId : 1, projectName: "Rem13", type: "project", date: "18 MIN AGO", tag: "Websign", notification: [{notiId: 1, title: "Domain", date: "350"}, {notiId: 2, title: "Support", date: "350"}, {notiId: 3, title: "Host", date: "980"}] },
